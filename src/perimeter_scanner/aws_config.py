...
class AwsConfig:
    ...
    @staticmethod
    def build_configuration(resource_type: ResourceType, configuration: str) -> Ec2Configuration | str:
        try:
        ...
        if resource_type == ResourceType.EC2_Instance:
            return Ec2Configuration(
                ...
                usage_operation_update_time=datetime.fromisoformat(configuration['usageOperationUpdateTime']),
                subnet_id=configuration['subnetId'],
                vpc_id=configuration['vpcId'],
            )
        return configuration

    def get_current_config_for_resource(self, resource_type: ResourceType, resource_id: str) -> ConfigItem | None:
        ...
        return ConfigItem(
            ...
            configuration=self.build_configuration(config_resource_type, config_item['configuration']),
